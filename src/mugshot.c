...
static const u32 sMugshotImg_Title[] = INCBIN_U32("graphics/mugshots/title_test.4bpp.lz");
static const u16 sMugshotPal_Title[] = INCBIN_U16("graphics/mugshots/title_test.gbapal");
