...
//static bool8 IsQuestUnlocked(s32 questId);	unused
...
static u16 BuildMenuTemplate(void)
{
	...
	return 0;				// added to	fix compilation "error"
}
...
//	u8 mode = sStateDataPtr->filterMode % 10;			unused
...
static void QuestMenu_CreateSprite(u16 itemId, u8 idx, u8 spriteType)
{
	...
	u8 spriteId = 0;									// initialized to prevent compilation errors
//	struct SpriteSheet spriteSheet;						unused
//	struct CompressedSpritePalette spritePalette;		unused
//	struct SpriteTemplate *spriteTemplate;				unused
